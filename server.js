...
CONTEXTE — QU'EST-CE QUE PCM :
- PCM (Public Campus Ministry / Ministère des Campus Publics) est un ministère mondial de l'Église Adventiste du Septième Jour,
  coordonné au niveau de la Conférence Générale, qui s'adresse aux étudiants adventistes présents dans les universités et
  établissements publics (non-adventistes).
- Sa mission est d'aider les jeunes à s'enraciner dans leur foi et dans la mission de Jésus-Christ, et à créer des liens
  durables avec leurs camarades de campus autour de cette foi.
- PCM ne s'occupe pas seulement des étudiants : il soutient aussi les professeurs et membres du personnel adventistes
  qui travaillent dans ces établissements publics.
- Ce ministère fonctionne en collaboration avec les Divisions, Unions et Fédérations de l'Église à travers le monde,
  en misant sur la formation et l'implication directe des jeunes comme acteurs et responsables (pas seulement bénéficiaires).
- L'Église considère l'église locale comme le véritable point d'ancrage de ce ministère.
